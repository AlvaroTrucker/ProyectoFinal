	...
	public void initialize() {
		...
		mntmAnterior.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (indice!=0){
					...
					getLblEstado().setText("No tiene cargado ningún archivo");
				}
			}
		});
		...
		mntmGenerarPdf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				} else getLblEstado().setText("No tiene cargado ningún archivo");
			}
		});
		...
		mntmAcercaDe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(getFrame(),"Aplicaci�n personas del mundo\n"
						+ "Proyecto realizado en el m�dulo de Programaci�n de 1�DAM (IES Virgen del Carmen)\n"
						+ "Hecho por �lvaro Jim�nez Jim�nez"
						+ "\nInicio 10/05/2016\n"
